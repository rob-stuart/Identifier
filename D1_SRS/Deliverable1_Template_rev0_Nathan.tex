...
% Begin SubSubSection
\begin{enumerate}[{UH}1. ]
	\item The application shall only be available to parks within Ontario.
\end{enumerate}
% End SubSubSection
...
% Begin SubSubSection
\begin{enumerate}[{PR}1. ]
	\item The application shall not compromise any information about the user of the application
