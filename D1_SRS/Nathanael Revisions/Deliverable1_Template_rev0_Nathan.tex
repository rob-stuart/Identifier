...
\begin{enumerate}[{LF}1. ]
	\item The application shall use the layout provided by the android SDK.
...
% Begin SubSubSection
\begin{enumerate}[{LF}1. ]
	\item The application shall display the team logo at the top of every team made application page.
...
% Begin SubSubSection
\begin{enumerate}[{PR}1. ]
	\item The application shall not be vulnerable to any user input. 
\end{enumerate}
% End SubSubSection
...
% Begin SubSubSection
\begin{enumerate}[{PR}1. ]
	\item The application shall be open for further development for different provinces.
\end{enumerate}
% End SubSubSection
...
% Begin SubSubSection
\begin{enumerate}[{PR}1. ]
	\item The application shall be available for download for at least 10 years. 
\end{enumerate}
% End SubSubSection
...
\begin{enumerate}[{OE}1. ]
	\item The application shall be used anywhere on any device
...
% Begin SubSubSection
\begin{enumerate}[{OE}1. ]
	\item The application will be easy to install.
	\item The application will be installed through the application store service.
\end{enumerate}
% End SubSubSection
...
% Begin SubSubSection
\begin{enumerate}[{CP}1. ]
	\item The application will be politically neutral regardless of where it will be used.
\end{enumerate}
% End SubSubSection
...
\begin{enumerate}[{LR}1. ]
	\item The application shall comply with the regional safety and confidentiality standards.
\end{enumerate}
% End SubSubSection
