...
\begin{enumerate}[{UH}1. ]
	\item The application shall be intuitive to use for anyone with a third grade education.
...
% Begin SubSubSection
\begin{enumerate}[{UH}1. ]
	\item The application shall be easy to learn for anyone with a third grade education.
	
	\item The application shall use language easy enough for anyone with a third grade education to understand. 
\end{enumerate}
% End SubSubSection
